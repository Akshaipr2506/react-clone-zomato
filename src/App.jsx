          ...
          <div className="col-md-5">
            <div className="card custom-card">
              <div className="image-container">
                <img
                  src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8ZGluaW5nfGVufDB8fDB8fHww" // Replace with your actual image
        ...
        <div className="row g-4">
          ...
          <div className="col-md-3 col-sm-6">
            <div className="card collection-card">
              <img
                src="https://images.pexels.com/photos/2067638/pexels-photo-2067638.jpeg?cs=srgb&dl=pexels-marta-dzedyshko-1042863-2067638.jpg&fm=jpg"
                className="card-img-top"
        ...
        <div className="row g-3">
          ...
          <div className="col-md-4 col-sm-6">
            <div className="border rounded px-3 py-4 locality-card">
              ...
              <p className="text-muted mt-2 mb-0">519 places</p>
            </div>
          </div>
          <div className="col-md-4 col-sm-6">
            <div className="border rounded px-3 py-4 locality-card">
              ...
              <p className="text-muted mt-2 mb-0">375 places</p>
            </div>
          </div>
          <div className="col-md-4 col-sm-6">
            <div className="border rounded px-3 py-4 locality-card">
              ...
              <p className="text-muted mt-2 mb-0">142 places</p>
            </div>
          </div>
          <div className="col-md-4 col-sm-6">
            <div className="border rounded px-3 py-4 locality-card">
              ...
              <p className="text-muted mt-2 mb-0">111 places</p>
            </div>
          </div>
          <div className="col-md-4 col-sm-6">
            <div className="border rounded px-3 py-4 locality-card">
              ...
              <p className="text-muted mt-2 mb-0">102 places</p>
            </div>
          </div>
          <div className="col-md-4 col-sm-6">
            <div className="border rounded px-3 py-4 locality-card">
              ...
              <p className="text-muted mt-2 mb-0">127 places</p>
            </div>
          </div>
          <div className="col-md-4 col-sm-6">
            <div className="border rounded px-3 py-4 locality-card">
              ...
              <p className="text-muted mt-2 mb-0">172 places</p>
            </div>
          </div>
          <div className="col-md-4 col-sm-6">
            <div className="border rounded px-3 py-4 locality-card">
              ...
              <p className="text-muted mt-2 mb-0">141 places</p>
            </div>
          </div>
          <div className="col-md-4 col-sm-6">
